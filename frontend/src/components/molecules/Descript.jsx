export default function Descript() {   
    return (
        <section className="flex mx-auto border rounded-2xl mb-10 bg-[#FFFFFF] border-[#E0E0E0] p-6 md:p-10 w-full max-w-[1200px] flex-col md:flex-row gap-10">
            
            {/* Left Side Numbered List */}
            <div className="w-full md:w-[40%]">
                <h1 className="font-bold text-lg md:text-[18px]">Why This Matters To You</h1>
                <ol className="list-decimal list-inside text-left space-y-4 md:space-y-6 mt-4 ">
            ...
            <div className="flex-1 w-full">
                <div className="flex flex-col md:flex-row gap-10">
                    <div className="flex-1 bg-[#F5F5F5] p-4 md:p-10 rounded-lg">
                        <h2 className="font-bold text-[#2E2E2E] text-lg md:text-[18px] py-2 md:py-3">45% Are Victims</h2>
                ...
                <div className="py-4 md:py-10">
                    <div className="bg-[#F5F5F5] p-4 md:pl-10 rounded-lg">
                        <h2 className="font-bold text-[#2E2E2E] text-lg md:text-[18px] py-2 md:py-3">33.4% Likely</h2>
                        <p className="text-[#2E2E2E] text-sm md:text-base">
